<div class="row">
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <input type="hidden" name="firstname" value="анонимный пользователь" />
      <input type="hidden" name="lastname" value="анонимный пользователь" />
      <input type="hidden" name="fax" value=" " />
      <input type="hidden" name="company" value=" " />
      <input type="hidden" name="address_1" value="нет данных" />
      <input type="hidden" name="address_2" value="нет данных" />
      <input type="hidden" name="postcode" value="нет данных" />
      <input type="hidden" name="city" value="москва" />
      <input type="hidden" name="country_id" value="11" />
      <input type="hidden" name="zone_id" value="11" />
