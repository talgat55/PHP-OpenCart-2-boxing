<form class="form-horizontal">
  <div class="form-group required no-dispaly">
    ...
    <div class="col-sm-10">
      <input type="text" name="firstname" value="нет данных" placeholder="<?php echo $entry_firstname; ?>" id="input-shipping-firstname" class="form-control" />
    </div>
  </div>
  <div class="form-group required no-dispaly">
    <label class="col-sm-2 control-label" for="input-shipping-lastname"><?php echo $entry_lastname; ?></label>
    <div class="col-sm-10">
      <input type="text" name="lastname" value="нет данных" placeholder="<?php echo $entry_lastname; ?>" id="input-shipping-lastname" class="form-control" />
    </div>
  </div>
  <div class="form-group no-dispaly">
  ...
  <div class="form-group required no-dispaly">
    ...
    <div class="col-sm-10">
      <input type="text" name="postcode" value="нет данных" placeholder="<?php echo $entry_postcode; ?>" id="input-shipping-postcode" class="form-control" />
    </div>
  </div>
  <div class="form-group required no-dispaly">
    ...
    <div class="col-sm-10">
      <select name="country_id" id="input-shipping-country" class="form-control">
        <option selected  value="нет данных">нет</option>
