            ...
            <div class="form-wrapper">
                ...
                <div class="form-group required">
                    ...
                    <input type="text" class="form-control"
                           ...
                           id="sobInput<?php echo $module_id; ?>-<?php echo $field_row; ?>" data-minlength="3" required=""
                           placeholder="<?php echo $field['name']; ?>">
                    <button type="submit" class="btn btn-lg btn-primary pull-right"><img src="/catalog/view/theme/theme/image/main/button-form.png" alt="Иконка "/></button>
                    <div class="help-block with-errors"></div>
                    <input type="hidden" class="form-control" name="sob_input[<?php echo $field_row; ?>][required]"
                           id="sobInputHiddden<?php echo $module_id; ?>-<?php echo $field_row; ?>" value="input">
                </div>
            ...
            <form role="form" data-toggle="validator" enctype="multipart/form-data"
                ...
                <div class="form-group required">
                    ...
                    <textarea class="form-control"
                              ...
                              data-minlength="5" required="" placeholder="<?php echo $field['name']; ?>"></textarea>
                    <div class="help-block with-errors"></div>
                    <input type="hidden" class="form-control" name="sob_input[<?php echo $field_row; ?>][required]"
                           id="sobInputTextHidden<?php echo $module_id; ?>-<?php echo $field_row; ?>" value="textarea">
                </div>
                <?php } else { ?>
                <div class="form-group">
                ...
                <div class="form-group required">
                    ...
                    <input type="hidden" class="form-control" name="sob_input[<?php echo $field_row; ?>][required]"
                           id="sobInputRadioHidden<?php echo $module_id; ?>-<?php echo $field_row; ?>" value="radio">
                </div>
                <?php } else { ?>
                <div class="form-group">
                ...
                <div class="form-group required">
                    ...
                    <div class="help-block with-errors"></div>
                    <input type="hidden" class="form-control" name="sob_input[<?php echo $field_row; ?>][required]"
                           id="sobInputCheckboxHidden<?php echo $module_id; ?>-<?php echo $field_row; ?>" value="checkbox">
                </div>
                <?php } else { ?>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="sobInput<?php echo $module_id; ?>-<?php echo $field_row; ?>"><?php echo $field['name']; ?></label>
                    <input type="text" id="sobInput<?php echo $module_id; ?>-<?php echo $field_row; ?>" class="form-control"
                           name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']; ?>]"
                           placeholder="<?php echo $field['name']; ?>">
                </div>
                <?php } ?>
