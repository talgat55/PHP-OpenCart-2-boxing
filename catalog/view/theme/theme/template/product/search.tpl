...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> search-page"><?php echo $content_top; ?>
      ...
      <div class="row products-row">
        ...
        <div class="product-layout product-grid col-lg-3 col-md-3 col-sm-6 col-xs-12 col-xs-12">
