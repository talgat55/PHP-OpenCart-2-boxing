...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
        ...
        $query_promotion = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_special  WHERE product_id=" .$query->row['product_id']  );
		...
		if ($query->num_rows) {
			return array(
				...
				'date_end_promotion'=> $query_promotion->row['date_end'],
