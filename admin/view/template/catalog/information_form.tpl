                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information"
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-data">
                            ...
                            <!-- custom field   Video review -->
                           <?php  /* <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-status"><?php echo $videoobzor_title; ?></label>
                                <div class="col-sm-10">
                                    <select name="status_video" id="input-status" class="form-control">
                                        <?php if ($status_video) { ?>
                                        <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                                        <option value="0"><?php echo $text_disabled; ?></option>
                                        <?php } else { ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-sort-order"><?php echo $videoobzor_title_youtube; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="video_link" value="<?php echo $video_link; ?>"
                                           placeholder="<?php echo $videoobzor_title; ?>" id="input-sort-order"
                                           class="form-control"/>
                                </div>
                            </div> */ ?>
                            <!-- -->
